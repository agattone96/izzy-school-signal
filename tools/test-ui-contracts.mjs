...
assert.doesNotMatch(controller,/initialLaunch&&source\.kind==="ics-url"/);
...
assert.match(controller,/CalendarProvider\.syncPreparedPublicCalendar\(\)/);
...
assert.doesNotMatch(controller,/\["","app"\]\.includes\(launchAction\)/);
assert.doesNotMatch(read("src/90-runtime.js"),/autoSyncOnOpen&&source\.kind/);
